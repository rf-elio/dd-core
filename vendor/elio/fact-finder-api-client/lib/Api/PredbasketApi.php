...
class PredbasketApi
{
     ...
     */
    public function getPredictionsUsingGET($channel, $user_id, $max_results = '0', $filter = null, $blacklist = null, $purchaser_id = null, $ids_only = 'false')
    {
        list($response) = $this->getPredictionsUsingGETWithHttpInfo($channel, $user_id, $max_results, $filter, $blacklist, $purchaser_id, $ids_only);
        return $response;
    }
     ...
     */
    public function getPredictionsUsingGETWithHttpInfo($channel, $user_id, $max_results = '0', $filter = null, $blacklist = null, $purchaser_id = null, $ids_only = 'false')
    {
        $returnType = '\Swagger\Client\Model\PredictiveBasketResult';
        $request = $this->getPredictionsUsingGETRequest($channel, $user_id, $max_results, $filter, $blacklist, $purchaser_id, $ids_only);
     ...
     */
    public function getPredictionsUsingGETAsync($channel, $user_id, $max_results = '0', $filter = null, $blacklist = null, $purchaser_id = null, $ids_only = 'false')
    {
        return $this->getPredictionsUsingGETAsyncWithHttpInfo($channel, $user_id, $max_results, $filter, $blacklist, $purchaser_id, $ids_only)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPredictionsUsingGETAsyncWithHttpInfo($channel, $user_id, $max_results = '0', $filter = null, $blacklist = null, $purchaser_id = null, $ids_only = 'false')
    {
        $returnType = '\Swagger\Client\Model\PredictiveBasketResult';
        $request = $this->getPredictionsUsingGETRequest($channel, $user_id, $max_results, $filter, $blacklist, $purchaser_id, $ids_only);
     ...
     */
    protected function getPredictionsUsingGETRequest($channel, $user_id, $max_results = '0', $filter = null, $blacklist = null, $purchaser_id = null, $ids_only = 'false')
    {
        ...
        if ($max_results !== null && $max_results < 0) {
            throw new \InvalidArgumentException('invalid value for "$max_results" when calling PredbasketApi.getPredictionsUsingGET, must be bigger than or equal to 0.');
        }
