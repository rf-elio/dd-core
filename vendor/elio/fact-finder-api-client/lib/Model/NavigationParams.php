...
class NavigationParams implements ModelInterface, ArrayAccess
{
    ...
    public function setMaxDistance($max_distance)
    {
        ...
        if (!is_null($max_distance) && ($max_distance < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_distance when calling NavigationParams., must be bigger than or equal to 1.');
        }
    ...
    public function setPurchaserId($purchaser_id)
    {
        if (!is_null($purchaser_id) && (mb_strlen($purchaser_id) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $purchaser_id when calling NavigationParams., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($purchaser_id) && (mb_strlen($purchaser_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purchaser_id when calling NavigationParams., must be bigger than or equal to 1.');
        }
