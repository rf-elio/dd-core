...
class ProductSortingAdminController extends AbstractController
{
    ...
    #[Route(path:'/api/_action/elio-data-discovery/recalculate-sort', name: 'api.custom.elio_data_discovery_product_sorting.recalculate-sort', methods: ['GET'] )]
    public function recalculateSort(): Response
    {
