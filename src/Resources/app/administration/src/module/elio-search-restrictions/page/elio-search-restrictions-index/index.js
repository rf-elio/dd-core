import template from './elio-search-restrictions-index.html.twig';

Shopware.Component.register('elio-search-restrictions-index', {
    template: template,
    ...
    methods: {
        ...
        routerViewTabChanged() {
            if (this.$route.name === 'elio.search.restrictions.index.customfilters') {
