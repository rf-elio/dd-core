import template from './elio-search-restrictions-customfilters.html.twig';

const { Mixin } = Shopware;
const { Criteria } = Shopware.Data;

Shopware.Component.register('elio-search-restrictions-customfilters', {
    template: template,
    ...
    methods: {
        ...
        getFiltersColumns() {
            return [{
                ...
                routerLink: 'elio.search.restrictions.customFiltersDetail',
                inlineEdit: 'string',
                allowResize: false,
                primary: true
            }];
