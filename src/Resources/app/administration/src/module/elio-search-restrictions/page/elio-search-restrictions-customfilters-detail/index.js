import template from './elio-search-restrictions-customfilters-detail.html.twig';

const { Mixin } = Shopware;
const { Criteria } = Shopware.Data;

Shopware.Component.register('elio-search-restrictions-customfilters-detail', {
    template: template,
    ...
    methods: {
        ...
        onSave() {
            ...
            return this.filterRepository.save(this.filter).then(() => {
                ...
                this.createNotificationError({
                    message: this.$tc('elio-search.restrictions.filters.messageSaveError')
                });
                this.isLoading = false;
                throw exception;
            });
        ...
        onCancel() {
            this.$router.push({ name: 'elio.search.restrictions.index.customfilters' });
        }
    }
});