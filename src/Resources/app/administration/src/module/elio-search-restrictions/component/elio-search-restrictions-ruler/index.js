import template from './elio-search-restriction-ruler.html.twig';
import './elio-search-restriction-ruller.scss';

const {Criteria} = Shopware.Data;

Shopware.Component.register('elio-search-restriction-ruler', {
    template: template,
    ...
    methods: {
        ...
        async loadFilters() {
            ...
            try {
                ...
                this.isLoading = false;
                this.$router.push({name: 'elio.search.restrictions.index.global'});
            }
        },
