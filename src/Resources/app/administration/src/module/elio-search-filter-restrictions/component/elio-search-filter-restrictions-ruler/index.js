import template from './elio-search-filter-restriction-ruler.html.twig';
import './elio-search-filter-restriction-ruller.scss';

const {Criteria} = Shopware.Data;

Shopware.Component.register('elio-search-filter-restriction-ruler', {
    template: template,
    ...
    methods: {
        ...
        async loadFilters() {
            ...
            try {
                ...
                criteria.addFilter(Criteria.equals('filters.type', 'filter'))
